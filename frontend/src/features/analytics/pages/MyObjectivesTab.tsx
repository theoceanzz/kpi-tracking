      ...
      <div className={cn(
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0">
            <h2 className={cn("font-bold text-slate-900 dark:text-white leading-tight transition-all duration-200", filterStuck ? "text-sm" : "text-base")}>Bộ lọc mục tiêu của tôi</h2>
            {!filterStuck && (
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-5 w-full lg:w-auto lg:shrink-0">
          <label className="flex items-center gap-2 text-sm font-semibold text-slate-700 dark:text-slate-300 cursor-pointer select-none whitespace-nowrap shrink-0">
            <input
              type="checkbox"
