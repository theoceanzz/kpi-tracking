...
import { Target, FileText, CheckCircle, XCircle, Clock, Award, TrendingUp, Star, Settings, Settings2, GripVertical, X, Eye, EyeOff, Layout, Save, RotateCcw, Hash, Table2, BarChart3 as BarChartIcon, Plus, Trash2, PieChart as PieChartIcon, Bell, Activity, List as ListIcon, Info, ArrowUpDown, Search, ChevronLeft, ChevronRight, Copy } from 'lucide-react'
