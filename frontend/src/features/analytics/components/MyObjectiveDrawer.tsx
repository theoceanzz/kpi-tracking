          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-end gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 bg-[var(--color-card)] p-1 rounded-control border border-[var(--color-border)] /10 shadow-sm text-sm w-full sm:w-auto">
              ...
              {dateFilterType === 'CUSTOM' && (
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 px-2 border-t sm:border-t-0 sm:border-l border-[var(--color-border)] /10 pt-2 sm:pt-0">
                  <input 
                    type="date" 
                    className="bg-transparent border-none outline-none text-[var(--color-foreground)] text-xs w-full sm:w-auto"
