...
export const kpiApi = {
  getAll: (params: { page?: number; size?: number; status?: KpiStatus; orgUnitId?: string; createdById?: string; kpiPeriodId?: string; sortBy?: string; sortDir?: string }) =>
  ...
  getMy: (params: { page?: number; size?: number; kpiPeriodId?: string; sortBy?: string; sortDir?: string }) =>
