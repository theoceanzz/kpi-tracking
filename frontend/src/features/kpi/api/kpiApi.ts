...
export const kpiApi = {
  getAll: (params: { page?: number; size?: number; status?: KpiStatus; orgUnitId?: string; organizationId?: string; createdById?: string; kpiPeriodId?: string; keyword?: string; sortBy?: string; sortDir?: string }) =>
  ...
  getMy: (params: { page?: number; size?: number; kpiPeriodId?: string; sortBy?: string; sortDir?: string; userId?: string }) =>
