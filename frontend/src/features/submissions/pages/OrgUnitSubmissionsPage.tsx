      ...
      <div className="max-w-[1600px] mx-auto space-y-8 animate-in fade-in duration-700">
        ...
        {selectedSubs.length > 0 && (
          <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 animate-in slide-in-from-bottom-8 duration-500">
            <div className="bg-slate-900 dark:bg-emerald-950 text-white px-8 py-3.5 rounded-[24px] shadow-2xl flex items-center gap-6 border border-white/10 backdrop-blur-xl">
              <div className="flex items-center gap-3 border-r border-white/10 pr-6 whitespace-nowrap">
                <div className="flex flex-col items-start">
                  <span className="text-[10px] font-black uppercase tracking-widest text-emerald-500/50">Đã chọn</span>
                  <span className="text-sm font-black tracking-tight">{selectedSubs.length} mục</span>
                </div>
                <button 
