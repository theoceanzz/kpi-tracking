  ...
  return (
    <button
      ...
      className={cn(
        ...
        listening
          ? 'bg-[var(--color-error-solid)] text-white hover:bg-[var(--color-error-solid)]'
    ...
    >
      ...
      {listening && (
        <span className="absolute -top-0.5 -right-0.5 h-2 w-2 rounded-full bg-[var(--color-error-solid)]"/>
      )}
    </button>
  )
}
