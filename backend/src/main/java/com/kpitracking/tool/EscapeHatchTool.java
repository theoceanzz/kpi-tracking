...
public class EscapeHatchTool {
    ...
    @Tool(name = "need_other_tools", value = "Gọi khi các công cụ hiện có KHÔNG đủ để trả lời "
    ...
    public String needOtherTools(NeedOtherToolsRequest request, InvocationParameters context) {
