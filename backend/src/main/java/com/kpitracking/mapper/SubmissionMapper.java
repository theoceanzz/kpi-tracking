...
public interface SubmissionMapper {
    ...
    @Mapping(source = "submittedBy", target = "submittedById", qualifiedByName = "userId")
    @Mapping(source = "submittedBy", target = "submittedByName", qualifiedByName = "userName")
    @Mapping(source = "reviewedBy", target = "reviewedById", qualifiedByName = "userId")
    ...
    @Mapping(source = "kpiCriteria.kpiPeriod", target = "kpiPeriod.id", qualifiedByName = "periodId")
