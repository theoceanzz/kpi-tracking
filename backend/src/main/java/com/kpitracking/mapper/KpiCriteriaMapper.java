...
public interface KpiCriteriaMapper {
    ...
    @Mapping(source = "scorecardPerspective.id", target = "scorecardPerspectiveId")
    @Mapping(source = "scorecardPerspective.perspective.name", target = "scorecardPerspectiveName")
    @Mapping(source = "scorecardPerspective.scorecard.name", target = "scorecardName")
