...
public class EmailService {
    ...
    public void sendEmail(String to, String subject, String htmlBody) {
        try {
            ...
            helper.setFrom(fromEmail, "KPI Tracking System");
            helper.setTo(to);
    ...
    private String buildHtmlTemplate(String title, String content) {
        return "<!DOCTYPE html>" +
               ...
               "<div class='footer'><p>Được gửi tự động từ <b>Hệ thống Quản trị KPI Tracking</b>.<br>Vui lòng không cung cấp mã này cho bất kỳ ai.</p></div>" +
               "</div></body></html>";
    }
    ...
    public void sendResetPasswordEmail(String to, String resetPasswordToken) {
        ...
        String content = "<p>Xin chào,</p>" +
                         ...
                         "<p>Trân trọng,<br><b>Ban Quản trị An ninh KPI Tracking</b></p>";
    ...
    public void sendVerifyEmail(String to, String verifyEmailToken) {
        String subject = "Xác nhận Tham gia Mạng lưới KPI Tracking";
        String content = "<p>Chào mừng bạn đã gia nhập,</p>" +
                         ...
                         "<p>Để hoàn tất thủ tục đăng ký, vui lòng sử dụng <b>Mã Token Xác Định</b> (đã mã hóa) dưới đây để kích hoạt:</p>" +
    ...
    public void sendWelcomeEmail(String to, String fullName) {
        String subject = "Chào mừng tới Hệ sinh thái KPI Tracking";
        String content = "<p>Xin chào <b>" + fullName + "</b>,</p>" +
                         "<p>Chúc mừng bạn! Hồ sơ và dữ liệu hệ thống của công ty đã được khởi tạo thành công trên nền tảng KPI Tracking.</p>" +
                         ...
                         "<p>Trân trọng,<br><b>Ban Giám đốc KPI Tracking</b></p>";
