...
INSERT INTO qualitative_levels (organization_id, name, level_value, position_index, color) VALUES
    ('11111111-1111-1111-1111-111111111111', 'KÉM',        0.0, 1, '#ef4444'),
    ('11111111-1111-1111-1111-111111111111', 'YẾU',        2.0, 2, '#f59e0b'),
    ('11111111-1111-1111-1111-111111111111', 'TRUNG BÌNH', 3.0, 3, '#6366f1'),
    ('11111111-1111-1111-1111-111111111111', 'KHÁ',        3.5, 4, '#3b82f6'),
    ('11111111-1111-1111-1111-111111111111', 'TỐT',        4.5, 5, '#10b981');
...
-- Qualitative ("định tính") Levels — default 5-level behavior scale
INSERT INTO qualitative_levels (organization_id, name, level_value, position_index, color) VALUES
    ('22222222-2222-2222-2222-222222222222', 'KÉM',        0.0, 1, '#ef4444'),
    ('22222222-2222-2222-2222-222222222222', 'YẾU',        2.0, 2, '#f59e0b'),
    ('22222222-2222-2222-2222-222222222222', 'TRUNG BÌNH', 3.0, 3, '#6366f1'),
    ('22222222-2222-2222-2222-222222222222', 'KHÁ',        3.5, 4, '#3b82f6'),
    ('22222222-2222-2222-2222-222222222222', 'TỐT',        4.5, 5, '#10b981')
ON CONFLICT DO NOTHING;
