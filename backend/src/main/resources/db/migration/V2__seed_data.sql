...
INSERT INTO organizations (id, name, code, evaluation_max_score, kpi_reminder_percentage) VALUES
    ('11111111-1111-1111-1111-111111111111', 'Demo Company', 'DEMO1', 100.0, 50);
...
VALUES
    ('9f4187ab-d4bd-4a73-a21a-eff99273dd27', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '33333333-0000-0000-0000-000000000104',
     'Số task hoàn thành', 'Hoàn thành task trong sprint', 50,
     50, 35, 'task', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', '22222222-0000-0000-0000-000000000100', '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('7924184d-c084-44a1-ae37-3c6b61d518fc', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '33333333-0000-0000-0000-000000000104',
     'Tỉ lệ bug', 'Tỉ lệ bug/feature không vượt ngưỡng', 50,
     5, 10, '%', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', '22222222-0000-0000-0000-000000000100', '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('1af7d756-973d-4680-bca0-de8e20b5c6f7', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '33333333-0000-0000-0000-000000000105',
     'Số task hoàn thành', 'Hoàn thành task trong sprint', 50,
     50, 35, 'task', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', '22222222-0000-0000-0000-000000000100', '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('a536373a-4a01-4b25-b8f9-15c7cd479c94', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '33333333-0000-0000-0000-000000000105',
     'Tỉ lệ bug', 'Tỉ lệ bug/feature không vượt ngưỡng', 50,
     5, 10, '%', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', '22222222-0000-0000-0000-000000000100', '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('0888dfd5-b2c6-41ea-b925-b1b73e45dc85', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '33333333-0000-0000-0000-000000000106',
     'Số task hoàn thành', 'Hoàn thành task trong sprint', 50,
     50, 35, 'task', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', '22222222-0000-0000-0000-000000000100', '2026-06-02 08:00:00+07', '2026-06-03 08:00:00+07'),
    ('9e2395d5-e706-4643-bb5c-1fa5d4d829db', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '33333333-0000-0000-0000-000000000106',
     'Tỉ lệ bug', 'Tỉ lệ bug/feature không vượt ngưỡng', 50,
     5, 10, '%', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', '22222222-0000-0000-0000-000000000100', '2026-06-02 08:00:00+07', '2026-06-03 08:00:00+07'),
    ('ce79b3ee-d13c-443c-a838-019784af9c82', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '33333333-0000-0000-0000-000000000104',
     'Số bài đăng', 'Số bài đăng trên các kênh truyền thông', 50,
     30, 20, 'bài', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000500', '22222222-0000-0000-0000-000000000100', '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('577305f2-af2b-4e4b-b695-babda1ee0695', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '33333333-0000-0000-0000-000000000104',
     'Lượt tương tác', 'Tổng lượt like/share/comment', 50,
     5000, 3000, 'lượt', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000500', '22222222-0000-0000-0000-000000000100', '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('843fc0ed-4784-414d-a09e-0ad177c651e9', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '33333333-0000-0000-0000-000000000105',
     'Số bài đăng', 'Số bài đăng trên các kênh truyền thông', 50,
     30, 20, 'bài', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000500', '22222222-0000-0000-0000-000000000100', '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('d04e377f-7c67-42d7-9986-620c6ea83f09', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '33333333-0000-0000-0000-000000000105',
     'Lượt tương tác', 'Tổng lượt like/share/comment', 50,
     5000, 3000, 'lượt', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000500', '22222222-0000-0000-0000-000000000100', '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('b98cd2b1-2f7a-4b74-8f43-7510f06fad00', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '33333333-0000-0000-0000-000000000106',
     'Số bài đăng', 'Số bài đăng trên các kênh truyền thông', 50,
     30, 20, 'bài', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000500', '22222222-0000-0000-0000-000000000100', '2026-06-02 08:00:00+07', '2026-06-03 08:00:00+07'),
    ('a357baae-1005-4f1b-8eba-0670a20a0055', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '33333333-0000-0000-0000-000000000106',
     'Lượt tương tác', 'Tổng lượt like/share/comment', 50,
     5000, 3000, 'lượt', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000500', '22222222-0000-0000-0000-000000000100', '2026-06-02 08:00:00+07', '2026-06-03 08:00:00+07'),
    ('21f3bb63-11a3-40c3-9395-176c0bd74583', 'dddddddd-dddd-dddd-dddd-dddddddddddd', '33333333-0000-0000-0000-000000000104',
     'API hoàn thành', 'Số API endpoint hoàn thành và pass test', 50,
     20, 12, 'endpoint', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000300', '22222222-0000-0000-0000-000000000101', '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('57de5627-31cb-4299-87c3-d370f0a00a10', 'dddddddd-dddd-dddd-dddd-dddddddddddd', '33333333-0000-0000-0000-000000000104',
     'Code review', 'Số PR được review đúng SLA', 50,
     30, 20, 'PR', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000300', '22222222-0000-0000-0000-000000000101', '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('0bbdca82-a6d6-46dd-a4ad-48062d9353b0', 'dddddddd-dddd-dddd-dddd-dddddddddddd', '33333333-0000-0000-0000-000000000105',
     'API hoàn thành', 'Số API endpoint hoàn thành và pass test', 50,
     20, 12, 'endpoint', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000300', '22222222-0000-0000-0000-000000000101', '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('f15a537e-4f63-4947-a750-ec62ab53c51e', 'dddddddd-dddd-dddd-dddd-dddddddddddd', '33333333-0000-0000-0000-000000000105',
     'Code review', 'Số PR được review đúng SLA', 50,
     30, 20, 'PR', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000300', '22222222-0000-0000-0000-000000000101', '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('3daf855a-72f5-4941-aa42-37d13a1440f1', 'dddddddd-dddd-dddd-dddd-dddddddddddd', '33333333-0000-0000-0000-000000000106',
     'API hoàn thành', 'Số API endpoint hoàn thành và pass test', 50,
     20, 12, 'endpoint', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000300', '22222222-0000-0000-0000-000000000101', '2026-06-02 08:00:00+07', '2026-06-03 08:00:00+07'),
    ('ba7db630-5356-45fd-a201-c60efdd1c252', 'dddddddd-dddd-dddd-dddd-dddddddddddd', '33333333-0000-0000-0000-000000000106',
     'Code review', 'Số PR được review đúng SLA', 50,
     30, 20, 'PR', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000300', '22222222-0000-0000-0000-000000000101', '2026-06-02 08:00:00+07', '2026-06-03 08:00:00+07'),
    ('98501d33-c8f4-4fae-a5fe-804dc17f48d5', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '33333333-0000-0000-0000-000000000104',
     'Số màn hình hoàn thành', 'Số UI screen hoàn thành và pass QA', 50,
     15, 10, 'màn hình', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000400', '22222222-0000-0000-0000-000000000101', '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('3271fa4b-0d70-4d21-895a-1e3435973010', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '33333333-0000-0000-0000-000000000104',
     'Điểm Lighthouse', 'Điểm trung bình Lighthouse Performance', 50,
     85, 70, 'điểm', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000400', '22222222-0000-0000-0000-000000000101', '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('6a6b79a4-dc6f-48c3-91df-730aaa25242c', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '33333333-0000-0000-0000-000000000105',
     'Số màn hình hoàn thành', 'Số UI screen hoàn thành và pass QA', 50,
     15, 10, 'màn hình', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000400', '22222222-0000-0000-0000-000000000101', '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('f2b49ab6-4214-4309-921e-7f039e9109a4', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '33333333-0000-0000-0000-000000000105',
     'Điểm Lighthouse', 'Điểm trung bình Lighthouse Performance', 50,
     85, 70, 'điểm', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000400', '22222222-0000-0000-0000-000000000101', '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('14bed331-c027-4e62-ab68-ace512f04c58', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '33333333-0000-0000-0000-000000000106',
     'Số màn hình hoàn thành', 'Số UI screen hoàn thành và pass QA', 50,
     15, 10, 'màn hình', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000400', '22222222-0000-0000-0000-000000000101', '2026-06-02 08:00:00+07', '2026-06-03 08:00:00+07'),
    ('05589489-95ec-4cca-a3a0-de9698b4b06e', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '33333333-0000-0000-0000-000000000106',
     'Điểm Lighthouse', 'Điểm trung bình Lighthouse Performance', 50,
     85, 70, 'điểm', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000400', '22222222-0000-0000-0000-000000000101', '2026-06-02 08:00:00+07', '2026-06-03 08:00:00+07'),
    ('d56e6f48-e0f5-44e9-a032-0c9423a55973', 'ffffffff-ffff-ffff-ffff-ffffffffffff', '33333333-0000-0000-0000-000000000104',
     'Số bài viết', 'Số bài viết content hoàn thành và đăng', 50,
     20, 12, 'bài', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000600', '22222222-0000-0000-0000-000000000500', '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('b494ce35-58ac-42e4-8efb-001c5a07393e', 'ffffffff-ffff-ffff-ffff-ffffffffffff', '33333333-0000-0000-0000-000000000104',
     'Tỉ lệ bài đúng hạn', 'Tỉ lệ bài nộp đúng deadline biên tập', 50,
     90, 70, '%', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000600', '22222222-0000-0000-0000-000000000500', '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('2eca1dfe-36ac-4359-9a65-ffcbe6c956ad', 'ffffffff-ffff-ffff-ffff-ffffffffffff', '33333333-0000-0000-0000-000000000105',
     'Số bài viết', 'Số bài viết content hoàn thành và đăng', 50,
     20, 12, 'bài', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000600', '22222222-0000-0000-0000-000000000500', '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('97634f31-0aba-46d5-b920-b095ec513b27', 'ffffffff-ffff-ffff-ffff-ffffffffffff', '33333333-0000-0000-0000-000000000105',
     'Tỉ lệ bài đúng hạn', 'Tỉ lệ bài nộp đúng deadline biên tập', 50,
     90, 70, '%', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000600', '22222222-0000-0000-0000-000000000500', '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('3d32416c-1169-4384-a3c9-6d890cfd5a59', 'ffffffff-ffff-ffff-ffff-ffffffffffff', '33333333-0000-0000-0000-000000000106',
     'Số bài viết', 'Số bài viết content hoàn thành và đăng', 50,
     20, 12, 'bài', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000600', '22222222-0000-0000-0000-000000000500', '2026-06-02 08:00:00+07', '2026-06-03 08:00:00+07'),
    ('e8a1a3a1-bd0a-42ce-a15c-977587238e20', 'ffffffff-ffff-ffff-ffff-ffffffffffff', '33333333-0000-0000-0000-000000000106',
     'Tỉ lệ bài đúng hạn', 'Tỉ lệ bài nộp đúng deadline biên tập', 50,
     90, 70, '%', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000600', '22222222-0000-0000-0000-000000000500', '2026-06-02 08:00:00+07', '2026-06-03 08:00:00+07'),
    ('ff24864e-6616-4c4c-947b-cea8defcb7a6', 'abcdefab-cdef-cdef-cdef-abcdefabcdef', '33333333-0000-0000-0000-000000000104',
     'Số asset thiết kế', 'Số asset (banner/infographic) hoàn thành', 50,
     25, 15, 'asset', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000700', '22222222-0000-0000-0000-000000000500', '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('ba76ff1a-2331-4262-98ba-a2c1f480caa8', 'abcdefab-cdef-cdef-cdef-abcdefabcdef', '33333333-0000-0000-0000-000000000104',
     'Tỉ lệ revise ≤ 2 lần', 'Tỉ lệ asset được duyệt trong 2 lần sửa', 50,
     80, 60, '%', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000700', '22222222-0000-0000-0000-000000000500', '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('c97782ca-253d-4e9b-b25d-fe527a76245b', 'abcdefab-cdef-cdef-cdef-abcdefabcdef', '33333333-0000-0000-0000-000000000105',
     'Số asset thiết kế', 'Số asset (banner/infographic) hoàn thành', 50,
     25, 15, 'asset', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000700', '22222222-0000-0000-0000-000000000500', '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('19dcb07f-0539-4ad7-86b8-7deea6ea3ae4', 'abcdefab-cdef-cdef-cdef-abcdefabcdef', '33333333-0000-0000-0000-000000000105',
     'Tỉ lệ revise ≤ 2 lần', 'Tỉ lệ asset được duyệt trong 2 lần sửa', 50,
     80, 60, '%', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000700', '22222222-0000-0000-0000-000000000500', '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('132952bd-3e85-46e1-84a0-93db48abf11f', 'abcdefab-cdef-cdef-cdef-abcdefabcdef', '33333333-0000-0000-0000-000000000106',
     'Số asset thiết kế', 'Số asset (banner/infographic) hoàn thành', 50,
     25, 15, 'asset', 'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000000700', '22222222-0000-0000-0000-000000000500', '2026-06-02 08:00:00+07', '2026-06-03 08:00:00+07'),
...
VALUES
    ('d65c5ad1-8dad-4284-b070-3340d575b671', 'b0000000-0000-0000-0000-000000000001', '33333333-0000-0000-0000-000000000101',
     'Điểm trung bình môn học', 'Điểm TB các môn học trong tháng (thang 10)', 50,
     7.5, 5.0, 'điểm',
     'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
     '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('dd10e330-fe48-42d3-96f2-4167272bfc56', 'b0000000-0000-0000-0000-000000000001', '33333333-0000-0000-0000-000000000101',
     'Điểm rèn luyện', 'Điểm rèn luyện tháng (thang 100)', 50,
     80, 50, 'điểm',
     'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
     '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('4a6cb8fe-1a78-4740-860d-a89fa5dea766', 'b0000000-0000-0000-0000-000000000001', '33333333-0000-0000-0000-000000000102',
     'Điểm trung bình môn học', 'Điểm TB các môn học trong tháng (thang 10)', 50,
     7.5, 5.0, 'điểm',
     'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
     '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('69303880-b11a-4005-9125-14fec645f4eb', 'b0000000-0000-0000-0000-000000000001', '33333333-0000-0000-0000-000000000102',
     'Điểm rèn luyện', 'Điểm rèn luyện tháng (thang 100)', 50,
     80, 50, 'điểm',
     'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
     '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('36ab170d-0741-4f0b-8ff5-6e183deabd19', 'b0000000-0000-0000-0000-000000000001', '33333333-0000-0000-0000-000000000103',
     'Điểm trung bình môn học', 'Điểm TB các môn học trong tháng (thang 10)', 50,
     7.5, 5.0, 'điểm',
     'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
     '2026-06-02 08:00:00+07', '2026-06-03 08:00:00+07'),
    ('a9a66314-7a25-4afe-b288-6336cfcca472', 'b0000000-0000-0000-0000-000000000001', '33333333-0000-0000-0000-000000000103',
     'Điểm rèn luyện', 'Điểm rèn luyện tháng (thang 100)', 50,
     80, 50, 'điểm',
     'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
    ...
    ('2f4bb251-bea1-4dfd-91be-6457c7c520fc', 'b0000000-0000-0000-0000-000000000002', '33333333-0000-0000-0000-000000000101',
     ...
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
     '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('4dc534e7-1b2d-4afc-a6db-dfb956187321', 'b0000000-0000-0000-0000-000000000002', '33333333-0000-0000-0000-000000000101',
     'Điểm rèn luyện', 'Điểm rèn luyện tháng (thang 100)', 50,
     80, 50, 'điểm',
     'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
     '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),
    ('8d905099-ca54-43c1-906f-c9cb94ce1f85', 'b0000000-0000-0000-0000-000000000002', '33333333-0000-0000-0000-000000000102',
     'Điểm trung bình môn học', 'Điểm TB các môn học trong tháng (thang 10)', 50,
     7.5, 5.0, 'điểm',
     'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
     '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('afe5133c-b8a7-4cb2-adee-65f0ad08637d', 'b0000000-0000-0000-0000-000000000002', '33333333-0000-0000-0000-000000000102',
     'Điểm rèn luyện', 'Điểm rèn luyện tháng (thang 100)', 50,
     80, 50, 'điểm',
     'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
     '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),
    ('62426faa-587f-4192-ad04-009960aff719', 'b0000000-0000-0000-0000-000000000002', '33333333-0000-0000-0000-000000000103',
     'Điểm trung bình môn học', 'Điểm TB các môn học trong tháng (thang 10)', 50,
     7.5, 5.0, 'điểm',
     'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
     '2026-06-02 08:00:00+07', '2026-06-03 08:00:00+07'),
    ('6c345520-98c2-4cbd-8b14-8304da50333a', 'b0000000-0000-0000-0000-000000000002', '33333333-0000-0000-0000-000000000103',
     'Điểm rèn luyện', 'Điểm rèn luyện tháng (thang 100)', 50,
     80, 50, 'điểm',
     'MONTHLY', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
...
-- ============================================================
-- TEST DATA: OBJECTIVES + KEY RESULTS + KPI CRITERIA (OKR-linked)
-- OBJ 1: Team Backend (Demo Company)  — Q2/2026
-- OBJ 2: BM Kỹ thuật phần mềm (Trường ĐH) — Q2/2026
-- ============================================================

-- OBJECTIVES
INSERT INTO objectives (id, organization_id, org_unit_id, code, name, description, start_date, end_date, status)
VALUES
    ('b2000001-0000-4000-8000-000000000001',
     ...
     'Cải thiện năng suất, giảm lỗi, tăng tỷ lệ delivery đúng hạn cho Team Backend trong Q2/2026',
    ...
    ('b2000001-0000-4000-8000-000000000002',
     ...
     'b0000000-0000-0000-0000-000000000001',
     'OBJ-EDU-01',
     'Nâng cao chất lượng đào tạo BM Kỹ thuật phần mềm',
     'Nâng cao kết quả học tập và điểm rèn luyện của sinh viên BM KTPM trong học kỳ Q2/2026',
     '2026-04-01', '2026-06-30', 'ACTIVE');

-- KEY RESULTS
INSERT INTO key_results (id, objective_id, code, name, description, target_value, current_value, unit)
VALUES
    -- KR cho OBJ-BE-01 (Team Backend)
    ('b2000002-0000-4000-8000-000000000001',
     'b2000001-0000-4000-8000-000000000001',
     'KR-BE-01', 'Tỷ lệ hoàn thành sprint đạt ≥ 90%',
     'Đo lường % story point hoàn thành trong mỗi sprint so với kế hoạch',
     90, 0, '%'),

    ('b2000002-0000-4000-8000-000000000002',
     'b2000001-0000-4000-8000-000000000001',
     'KR-BE-02', 'Tỷ lệ task không có bug đạt ≥ 95%',
     'Tỷ lệ task được merge mà không phát sinh bug trên production',
     95, 0, '%'),

    -- KR cho OBJ-EDU-01 (BM KTPM)
    ('b2000002-0000-4000-8000-000000000003',
     'b2000001-0000-4000-8000-000000000002',
     'KR-EDU-01', 'Điểm trung bình học phần ≥ 7.5',
     'Điểm TB tất cả các môn học của sinh viên trong bộ môn đạt từ 7.5 trở lên',
     7.5, 0, 'điểm'),

    ('b2000002-0000-4000-8000-000000000004',
     'b2000001-0000-4000-8000-000000000002',
     'KR-EDU-02', 'Điểm rèn luyện trung bình ≥ 80',
     'Điểm rèn luyện TB của sinh viên đạt từ 80 điểm (thang 100) trở lên',
     80, 0, 'điểm');

-- KPI CRITERIA gắn với Key Result (10 tiêu chí)
-- Team Backend: 3 kỳ × 2 KR = 6 tiêu chí (kpi_period 104→T4, 105→T5, 106→T6)
-- BM KTPM:      2 kỳ × 2 KR = 4 tiêu chí (kpi_period 101→T4, 102→T5)
INSERT INTO kpi_criteria
    (id, org_unit_id, kpi_period_id, name, description, weight,
     target_value, minimum_value, unit, frequency, key_result_id, status,
     created_by, approved_by, submitted_at, approved_at)
VALUES
    -- KR-BE-01: Sprint Completion Rate — T4, T5, T6
    ('b2000003-0000-4000-8000-000000000001',
     'dddddddd-dddd-dddd-dddd-dddddddddddd', '33333333-0000-0000-0000-000000000104',
     'Sprint Completion Rate', 'Tỷ lệ % story point hoàn thành trong sprint tháng 4', 50,
     90, 70, '%', 'MONTHLY', 'b2000002-0000-4000-8000-000000000001', 'APPROVED',
     '22222222-0000-0000-0000-000000000300', '22222222-0000-0000-0000-000000000101',
     '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),

    ('b2000003-0000-4000-8000-000000000002',
     'dddddddd-dddd-dddd-dddd-dddddddddddd', '33333333-0000-0000-0000-000000000105',
     'Sprint Completion Rate', 'Tỷ lệ % story point hoàn thành trong sprint tháng 5', 50,
     90, 70, '%', 'MONTHLY', 'b2000002-0000-4000-8000-000000000001', 'APPROVED',
     '22222222-0000-0000-0000-000000000300', '22222222-0000-0000-0000-000000000101',
     '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),

    ('b2000003-0000-4000-8000-000000000003',
     'dddddddd-dddd-dddd-dddd-dddddddddddd', '33333333-0000-0000-0000-000000000106',
     'Sprint Completion Rate', 'Tỷ lệ % story point hoàn thành trong sprint tháng 6', 50,
     90, 70, '%', 'MONTHLY', 'b2000002-0000-4000-8000-000000000001', 'APPROVED',
     '22222222-0000-0000-0000-000000000300', '22222222-0000-0000-0000-000000000101',
     '2026-06-02 08:00:00+07', '2026-06-03 08:00:00+07'),

    -- KR-BE-02: Bug-Free Rate — T4, T5, T6
    ('b2000003-0000-4000-8000-000000000004',
     'dddddddd-dddd-dddd-dddd-dddddddddddd', '33333333-0000-0000-0000-000000000104',
     'Bug-Free Task Rate', 'Tỷ lệ task merge không phát sinh bug production tháng 4', 50,
     95, 80, '%', 'MONTHLY', 'b2000002-0000-4000-8000-000000000002', 'APPROVED',
     '22222222-0000-0000-0000-000000000300', '22222222-0000-0000-0000-000000000101',
     '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),

    ('b2000003-0000-4000-8000-000000000005',
     'dddddddd-dddd-dddd-dddd-dddddddddddd', '33333333-0000-0000-0000-000000000105',
     'Bug-Free Task Rate', 'Tỷ lệ task merge không phát sinh bug production tháng 5', 50,
     95, 80, '%', 'MONTHLY', 'b2000002-0000-4000-8000-000000000002', 'APPROVED',
     '22222222-0000-0000-0000-000000000300', '22222222-0000-0000-0000-000000000101',
     '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),

    ('b2000003-0000-4000-8000-000000000006',
     'dddddddd-dddd-dddd-dddd-dddddddddddd', '33333333-0000-0000-0000-000000000106',
     'Bug-Free Task Rate', 'Tỷ lệ task merge không phát sinh bug production tháng 6', 50,
     95, 80, '%', 'MONTHLY', 'b2000002-0000-4000-8000-000000000002', 'APPROVED',
     '22222222-0000-0000-0000-000000000300', '22222222-0000-0000-0000-000000000101',
     '2026-06-02 08:00:00+07', '2026-06-03 08:00:00+07'),

    -- KR-EDU-01: Điểm TB học phần — T4, T5
    ('b2000003-0000-4000-8000-000000000007',
     'b0000000-0000-0000-0000-000000000001', '33333333-0000-0000-0000-000000000101',
     'Điểm TB học phần', 'Điểm trung bình các môn học của sinh viên BM KTPM tháng 4', 50,
     7.5, 5.0, 'điểm', 'MONTHLY', 'b2000002-0000-4000-8000-000000000003', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
     '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),

    ('b2000003-0000-4000-8000-000000000008',
     'b0000000-0000-0000-0000-000000000001', '33333333-0000-0000-0000-000000000102',
     'Điểm TB học phần', 'Điểm trung bình các môn học của sinh viên BM KTPM tháng 5', 50,
     7.5, 5.0, 'điểm', 'MONTHLY', 'b2000002-0000-4000-8000-000000000003', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
     '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07'),

    -- KR-EDU-02: Điểm rèn luyện — T4, T5
    ('b2000003-0000-4000-8000-000000000009',
     'b0000000-0000-0000-0000-000000000001', '33333333-0000-0000-0000-000000000101',
     'Điểm rèn luyện', 'Điểm rèn luyện tháng của sinh viên BM KTPM tháng 4 (thang 100)', 50,
     80, 50, 'điểm', 'MONTHLY', 'b2000002-0000-4000-8000-000000000004', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
     '2026-04-02 08:00:00+07', '2026-04-03 08:00:00+07'),

    ('b2000003-0000-4000-8000-000000000010',
     'b0000000-0000-0000-0000-000000000001', '33333333-0000-0000-0000-000000000102',
     'Điểm rèn luyện', 'Điểm rèn luyện tháng của sinh viên BM KTPM tháng 5 (thang 100)', 50,
     80, 50, 'điểm', 'MONTHLY', 'b2000002-0000-4000-8000-000000000004', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', '22222222-0000-0000-0000-000000001001',
     '2026-05-02 08:00:00+07', '2026-05-03 08:00:00+07');

-- ============================================================
-- TEST DATA: thêm 20 dòng kpi_criteria_assignees
-- Mục đích: test chức năng thống kê với nhiều thành viên hơn
-- ============================================================
INSERT INTO kpi_criteria_assignees (kpi_criteria_id, user_id) VALUES
    -- Group A: thêm user 103 (Phạm Thị Staff - Team Backend) vào 6 KPI của Phòng IT
    ('9f4187ab-d4bd-4a73-a21a-eff99273dd27', '22222222-0000-0000-0000-000000000103'),
    ('7924184d-c084-44a1-ae37-3c6b61d518fc', '22222222-0000-0000-0000-000000000103'),
    ('1af7d756-973d-4680-bca0-de8e20b5c6f7', '22222222-0000-0000-0000-000000000103'),
    ('a536373a-4a01-4b25-b8f9-15c7cd479c94', '22222222-0000-0000-0000-000000000103'),
    ('0888dfd5-b2c6-41ea-b925-b1b73e45dc85', '22222222-0000-0000-0000-000000000103'),
    ('9e2395d5-e706-4643-bb5c-1fa5d4d829db', '22222222-0000-0000-0000-000000000103'),
    -- Group B: thêm user 600 (Mai Văn Cont Lead - Team Content) vào 6 KPI của Phòng IT
    ('9f4187ab-d4bd-4a73-a21a-eff99273dd27', '22222222-0000-0000-0000-000000000600'),
    ('7924184d-c084-44a1-ae37-3c6b61d518fc', '22222222-0000-0000-0000-000000000600'),
    ('1af7d756-973d-4680-bca0-de8e20b5c6f7', '22222222-0000-0000-0000-000000000600'),
    ('a536373a-4a01-4b25-b8f9-15c7cd479c94', '22222222-0000-0000-0000-000000000600'),
    ('0888dfd5-b2c6-41ea-b925-b1b73e45dc85', '22222222-0000-0000-0000-000000000600'),
    ('9e2395d5-e706-4643-bb5c-1fa5d4d829db', '22222222-0000-0000-0000-000000000600'),
    -- Group C: thêm user 103 vào 4 KPI của Phòng Truyền Thông
    ('ce79b3ee-d13c-443c-a838-019784af9c82', '22222222-0000-0000-0000-000000000103'),
    ('577305f2-af2b-4e4b-b695-babda1ee0695', '22222222-0000-0000-0000-000000000103'),
    ('843fc0ed-4784-414d-a09e-0ad177c651e9', '22222222-0000-0000-0000-000000000103'),
    ('d04e377f-7c67-42d7-9986-620c6ea83f09', '22222222-0000-0000-0000-000000000103'),
    -- Group D: phân công chéo giữa 2 bộ môn để test thống kê đa đơn vị
    ('36ab170d-0741-4f0b-8ff5-6e183deabd19', '22222222-0000-0000-0000-000000001201'),
    ('a9a66314-7a25-4afe-b288-6336cfcca472', '22222222-0000-0000-0000-000000001201'),
    ('62426faa-587f-4192-ad04-009960aff719', '22222222-0000-0000-0000-000000001101'),
    ('6c345520-98c2-4cbd-8b14-8304da50333a', '22222222-0000-0000-0000-000000001101');

-- Assignees cho 10 criteria OKR mới (20 dòng)
-- IT Backend (6 criteria): assign user 300 + 301 → 6×2=12 rows
-- EDU BM1   (4 criteria): assign user 1101 + 1102 → 4×2=8 rows
INSERT INTO kpi_criteria_assignees (kpi_criteria_id, user_id) VALUES
    -- Sprint Completion Rate T4, T5, T6 — user 300 (TeamLead Backend)
    ('b2000003-0000-4000-8000-000000000001', '22222222-0000-0000-0000-000000000300'),
    ('b2000003-0000-4000-8000-000000000002', '22222222-0000-0000-0000-000000000300'),
    ('b2000003-0000-4000-8000-000000000003', '22222222-0000-0000-0000-000000000300'),
    -- Sprint Completion Rate T4, T5, T6 — user 301 (Deputy Lead Backend)
    ('b2000003-0000-4000-8000-000000000001', '22222222-0000-0000-0000-000000000301'),
    ('b2000003-0000-4000-8000-000000000002', '22222222-0000-0000-0000-000000000301'),
    ('b2000003-0000-4000-8000-000000000003', '22222222-0000-0000-0000-000000000301'),
    -- Bug-Free Task Rate T4, T5, T6 — user 300
    ('b2000003-0000-4000-8000-000000000004', '22222222-0000-0000-0000-000000000300'),
    ('b2000003-0000-4000-8000-000000000005', '22222222-0000-0000-0000-000000000300'),
    ('b2000003-0000-4000-8000-000000000006', '22222222-0000-0000-0000-000000000300'),
    -- Bug-Free Task Rate T4, T5, T6 — user 301
    ('b2000003-0000-4000-8000-000000000004', '22222222-0000-0000-0000-000000000301'),
    ('b2000003-0000-4000-8000-000000000005', '22222222-0000-0000-0000-000000000301'),
    ('b2000003-0000-4000-8000-000000000006', '22222222-0000-0000-0000-000000000301'),
    -- Điểm TB học phần T4, T5 — user 1101 (Trưởng BM KTPM)
    ('b2000003-0000-4000-8000-000000000007', '22222222-0000-0000-0000-000000001101'),
    ('b2000003-0000-4000-8000-000000000008', '22222222-0000-0000-0000-000000001101'),
    -- Điểm TB học phần T4, T5 — user 1102 (Phó BM KTPM)
    ('b2000003-0000-4000-8000-000000000007', '22222222-0000-0000-0000-000000001102'),
    ('b2000003-0000-4000-8000-000000000008', '22222222-0000-0000-0000-000000001102'),
    -- Điểm rèn luyện T4, T5 — user 1101
    ('b2000003-0000-4000-8000-000000000009', '22222222-0000-0000-0000-000000001101'),
    ('b2000003-0000-4000-8000-000000000010', '22222222-0000-0000-0000-000000001101'),
    -- Điểm rèn luyện T4, T5 — user 1102
    ('b2000003-0000-4000-8000-000000000009', '22222222-0000-0000-0000-000000001102'),
    ('b2000003-0000-4000-8000-000000000010', '22222222-0000-0000-0000-000000001102');

-- ============================================================
-- TEST DATA: thêm 20 dòng kpi_submissions
-- Mục đích: test chức năng thống kê với nhiều bài nộp hơn
-- ============================================================
INSERT INTO kpi_submissions
    (id, org_unit_id, kpi_criteria_id, submitted_by,
     actual_value, auto_score, note, status,
     reviewed_by, review_note, reviewed_at, period_start, period_end)
VALUES
    -- Submissions 1-6: user 103 (Phạm Thị Staff) nộp KPI Phòng IT
    ('a1b2c3d4-0001-4000-8000-100000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '9f4187ab-d4bd-4a73-a21a-eff99273dd27', '22222222-0000-0000-0000-000000000103',
     41, 41.0, '41 task', 'APPROVED',
     '22222222-0000-0000-0000-000000000100', 'Tốt', '2026-05-03 08:00:00+07',
     '2026-04-01 00:00:00+07', '2026-04-30 23:59:59+07'),
    ('a1b2c3d4-0002-4000-8000-100000000002', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '7924184d-c084-44a1-ae37-3c6b61d518fc', '22222222-0000-0000-0000-000000000103',
     8, 31.3, '8 %', 'APPROVED',
     '22222222-0000-0000-0000-000000000100', 'Tạm được', '2026-05-03 08:00:00+07',
     '2026-04-01 00:00:00+07', '2026-04-30 23:59:59+07'),
    ('a1b2c3d4-0003-4000-8000-100000000003', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '1af7d756-973d-4680-bca0-de8e20b5c6f7', '22222222-0000-0000-0000-000000000103',
     44, 44.0, '44 task', 'APPROVED',
     '22222222-0000-0000-0000-000000000100', 'Tốt', '2026-06-03 08:00:00+07',
     '2026-05-01 00:00:00+07', '2026-05-31 23:59:59+07'),
    ('a1b2c3d4-0004-4000-8000-100000000004', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'a536373a-4a01-4b25-b8f9-15c7cd479c94', '22222222-0000-0000-0000-000000000103',
     7, 35.7, '7 %', 'APPROVED',
     '22222222-0000-0000-0000-000000000100', 'Cần cải thiện', '2026-06-03 08:00:00+07',
     '2026-05-01 00:00:00+07', '2026-05-31 23:59:59+07'),
    ('a1b2c3d4-0005-4000-8000-100000000005', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '0888dfd5-b2c6-41ea-b925-b1b73e45dc85', '22222222-0000-0000-0000-000000000103',
     46, 46.0, '46 task', 'PENDING',
     NULL, NULL, NULL,
     '2026-06-01 00:00:00+07', '2026-06-30 23:59:59+07'),
    ('a1b2c3d4-0006-4000-8000-100000000006', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '9e2395d5-e706-4643-bb5c-1fa5d4d829db', '22222222-0000-0000-0000-000000000103',
     6, 41.7, '6 %', 'PENDING',
     NULL, NULL, NULL,
     '2026-06-01 00:00:00+07', '2026-06-30 23:59:59+07'),
    -- Submissions 7-10: user 103 nộp KPI Phòng Truyền Thông
    ('a1b2c3d4-0007-4000-8000-100000000007', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'ce79b3ee-d13c-443c-a838-019784af9c82', '22222222-0000-0000-0000-000000000103',
     22, 36.7, '22 bài', 'APPROVED',
     '22222222-0000-0000-0000-000000000100', 'Đạt', '2026-05-03 08:00:00+07',
     '2026-04-01 00:00:00+07', '2026-04-30 23:59:59+07'),
    ('a1b2c3d4-0008-4000-8000-100000000008', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '577305f2-af2b-4e4b-b695-babda1ee0695', '22222222-0000-0000-0000-000000000103',
     3800, 38.0, '3800 lượt', 'APPROVED',
     '22222222-0000-0000-0000-000000000100', 'Tốt', '2026-05-03 08:00:00+07',
     '2026-04-01 00:00:00+07', '2026-04-30 23:59:59+07'),
    ('a1b2c3d4-0009-4000-8000-100000000009', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '843fc0ed-4784-414d-a09e-0ad177c651e9', '22222222-0000-0000-0000-000000000103',
     26, 43.3, '26 bài', 'APPROVED',
     '22222222-0000-0000-0000-000000000100', 'Tốt', '2026-06-03 08:00:00+07',
     '2026-05-01 00:00:00+07', '2026-05-31 23:59:59+07'),
    ('a1b2c3d4-0010-4000-8000-100000000010', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'd04e377f-7c67-42d7-9986-620c6ea83f09', '22222222-0000-0000-0000-000000000103',
     4200, 42.0, '4200 lượt', 'APPROVED',
     '22222222-0000-0000-0000-000000000100', 'Tốt', '2026-06-03 08:00:00+07',
     '2026-05-01 00:00:00+07', '2026-05-31 23:59:59+07'),
    -- Submissions 11-14: phân công chéo bộ môn (user BM2 nộp KPI BM1 và ngược lại)
    ('a1b2c3d4-0011-4000-8000-100000000011', 'b0000000-0000-0000-0000-000000000001', '36ab170d-0741-4f0b-8ff5-6e183deabd19', '22222222-0000-0000-0000-000000001201',
     7.3, 48.7, '7.3 điểm', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', 'Tốt', '2026-07-03 08:00:00+07',
     '2026-06-01 00:00:00+07', '2026-06-30 23:59:59+07'),
    ('a1b2c3d4-0012-4000-8000-100000000012', 'b0000000-0000-0000-0000-000000000001', 'a9a66314-7a25-4afe-b288-6336cfcca472', '22222222-0000-0000-0000-000000001201',
     82, 50.0, '82 điểm', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', 'Xuất sắc', '2026-07-03 08:00:00+07',
     '2026-06-01 00:00:00+07', '2026-06-30 23:59:59+07'),
    ('a1b2c3d4-0013-4000-8000-100000000013', 'b0000000-0000-0000-0000-000000000002', '62426faa-587f-4192-ad04-009960aff719', '22222222-0000-0000-0000-000000001101',
     7.5, 50.0, '7.5 điểm', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', 'Xuất sắc', '2026-07-03 08:00:00+07',
     '2026-06-01 00:00:00+07', '2026-06-30 23:59:59+07'),
    ('a1b2c3d4-0014-4000-8000-100000000014', 'b0000000-0000-0000-0000-000000000002', '6c345520-98c2-4cbd-8b14-8304da50333a', '22222222-0000-0000-0000-000000001101',
     78, 48.8, '78 điểm', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', 'Tốt', '2026-07-03 08:00:00+07',
     '2026-06-01 00:00:00+07', '2026-06-30 23:59:59+07'),
    -- Submissions 15-20: user 600 (Mai Văn Cont Lead) nộp KPI Phòng IT
    ('a1b2c3d4-0015-4000-8000-100000000015', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '9f4187ab-d4bd-4a73-a21a-eff99273dd27', '22222222-0000-0000-0000-000000000600',
     38, 38.0, '38 task', 'APPROVED',
     '22222222-0000-0000-0000-000000000100', 'Đạt', '2026-05-03 08:00:00+07',
     '2026-04-01 00:00:00+07', '2026-04-30 23:59:59+07'),
    ('a1b2c3d4-0016-4000-8000-100000000016', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '7924184d-c084-44a1-ae37-3c6b61d518fc', '22222222-0000-0000-0000-000000000600',
     9, 27.8, '9 %', 'APPROVED',
     '22222222-0000-0000-0000-000000000100', 'Cần cải thiện', '2026-05-03 08:00:00+07',
     '2026-04-01 00:00:00+07', '2026-04-30 23:59:59+07'),
    ('a1b2c3d4-0017-4000-8000-100000000017', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '1af7d756-973d-4680-bca0-de8e20b5c6f7', '22222222-0000-0000-0000-000000000600',
     40, 40.0, '40 task', 'PENDING',
     NULL, NULL, NULL,
     '2026-05-01 00:00:00+07', '2026-05-31 23:59:59+07'),
    ('a1b2c3d4-0018-4000-8000-100000000018', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'a536373a-4a01-4b25-b8f9-15c7cd479c94', '22222222-0000-0000-0000-000000000600',
     7, 35.7, '7 %', 'PENDING',
     NULL, NULL, NULL,
     '2026-05-01 00:00:00+07', '2026-05-31 23:59:59+07'),
    ('a1b2c3d4-0019-4000-8000-100000000019', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '0888dfd5-b2c6-41ea-b925-b1b73e45dc85', '22222222-0000-0000-0000-000000000600',
     43, 43.0, '43 task', 'PENDING',
     NULL, NULL, NULL,
     '2026-06-01 00:00:00+07', '2026-06-30 23:59:59+07'),
    ('a1b2c3d4-0020-4000-8000-100000000020', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '9e2395d5-e706-4643-bb5c-1fa5d4d829db', '22222222-0000-0000-0000-000000000600',
     8, 31.3, '8 %', 'PENDING',
     NULL, NULL, NULL,
     '2026-06-01 00:00:00+07', '2026-06-30 23:59:59+07');

-- Submissions cho 10 criteria OKR mới (20 dòng)
-- Sprint Completion Rate: user300 & user301, T4/T5/T6 (score = actual/90*50)
-- Bug-Free Task Rate:     user300 & user301, T4/T5/T6 (score = actual/95*50)
-- Điểm TB học phần:       user1101 & user1102, T4/T5  (score = actual/7.5*50)
-- Điểm rèn luyện:         user1101 & user1102, T4/T5  (score = actual/80*50)
INSERT INTO kpi_submissions
    (id, org_unit_id, kpi_criteria_id, submitted_by,
     actual_value, auto_score, note, status,
     reviewed_by, review_note, reviewed_at, period_start, period_end)
VALUES
    -- Sprint Completion — user 300 (TeamLead): T4=88%, T5=91%, T6=93%
    ('b2000004-0000-4000-8000-000000000001', 'dddddddd-dddd-dddd-dddd-dddddddddddd',
     'b2000003-0000-4000-8000-000000000001', '22222222-0000-0000-0000-000000000300',
     88, 48.9, '88%', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', 'Tốt', '2026-05-03 08:00:00+07',
     '2026-04-01 00:00:00+07', '2026-04-30 23:59:59+07'),

    ('b2000004-0000-4000-8000-000000000002', 'dddddddd-dddd-dddd-dddd-dddddddddddd',
     'b2000003-0000-4000-8000-000000000002', '22222222-0000-0000-0000-000000000300',
     91, 50.0, '91%', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', 'Xuất sắc', '2026-06-03 08:00:00+07',
     '2026-05-01 00:00:00+07', '2026-05-31 23:59:59+07'),

    ('b2000004-0000-4000-8000-000000000003', 'dddddddd-dddd-dddd-dddd-dddddddddddd',
     'b2000003-0000-4000-8000-000000000003', '22222222-0000-0000-0000-000000000300',
     93, 50.0, '93%', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', 'Xuất sắc', '2026-07-03 08:00:00+07',
     '2026-06-01 00:00:00+07', '2026-06-30 23:59:59+07'),

    -- Sprint Completion — user 301 (Deputy Lead): T4=85%, T5=89%, T6=90%
    ('b2000004-0000-4000-8000-000000000004', 'dddddddd-dddd-dddd-dddd-dddddddddddd',
     'b2000003-0000-4000-8000-000000000001', '22222222-0000-0000-0000-000000000301',
     85, 47.2, '85%', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', 'Tốt', '2026-05-03 08:00:00+07',
     '2026-04-01 00:00:00+07', '2026-04-30 23:59:59+07'),

    ('b2000004-0000-4000-8000-000000000005', 'dddddddd-dddd-dddd-dddd-dddddddddddd',
     'b2000003-0000-4000-8000-000000000002', '22222222-0000-0000-0000-000000000301',
     89, 49.4, '89%', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', 'Tốt', '2026-06-03 08:00:00+07',
     '2026-05-01 00:00:00+07', '2026-05-31 23:59:59+07'),

    ('b2000004-0000-4000-8000-000000000006', 'dddddddd-dddd-dddd-dddd-dddddddddddd',
     'b2000003-0000-4000-8000-000000000003', '22222222-0000-0000-0000-000000000301',
     90, 50.0, '90%', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', 'Xuất sắc', '2026-07-03 08:00:00+07',
     '2026-06-01 00:00:00+07', '2026-06-30 23:59:59+07'),

    -- Bug-Free Task Rate — user 300: T4=88%, T5=92%, T6=96%
    ('b2000004-0000-4000-8000-000000000007', 'dddddddd-dddd-dddd-dddd-dddddddddddd',
     'b2000003-0000-4000-8000-000000000004', '22222222-0000-0000-0000-000000000300',
     88, 46.3, '88%', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', 'Tốt', '2026-05-03 08:00:00+07',
     '2026-04-01 00:00:00+07', '2026-04-30 23:59:59+07'),

    ('b2000004-0000-4000-8000-000000000008', 'dddddddd-dddd-dddd-dddd-dddddddddddd',
     'b2000003-0000-4000-8000-000000000005', '22222222-0000-0000-0000-000000000300',
     92, 48.4, '92%', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', 'Tốt', '2026-06-03 08:00:00+07',
     '2026-05-01 00:00:00+07', '2026-05-31 23:59:59+07'),

    ('b2000004-0000-4000-8000-000000000009', 'dddddddd-dddd-dddd-dddd-dddddddddddd',
     'b2000003-0000-4000-8000-000000000006', '22222222-0000-0000-0000-000000000300',
     96, 50.0, '96%', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', 'Xuất sắc', '2026-07-03 08:00:00+07',
     '2026-06-01 00:00:00+07', '2026-06-30 23:59:59+07'),

    -- Bug-Free Task Rate — user 301: T4=84%, T5=90%, T6=93%
    ('b2000004-0000-4000-8000-000000000010', 'dddddddd-dddd-dddd-dddd-dddddddddddd',
     'b2000003-0000-4000-8000-000000000004', '22222222-0000-0000-0000-000000000301',
     84, 44.2, '84%', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', 'Đạt', '2026-05-03 08:00:00+07',
     '2026-04-01 00:00:00+07', '2026-04-30 23:59:59+07'),

    ('b2000004-0000-4000-8000-000000000011', 'dddddddd-dddd-dddd-dddd-dddddddddddd',
     'b2000003-0000-4000-8000-000000000005', '22222222-0000-0000-0000-000000000301',
     90, 47.4, '90%', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', 'Tốt', '2026-06-03 08:00:00+07',
     '2026-05-01 00:00:00+07', '2026-05-31 23:59:59+07'),

    ('b2000004-0000-4000-8000-000000000012', 'dddddddd-dddd-dddd-dddd-dddddddddddd',
     'b2000003-0000-4000-8000-000000000006', '22222222-0000-0000-0000-000000000301',
     93, 48.9, '93%', 'APPROVED',
     '22222222-0000-0000-0000-000000000101', 'Tốt', '2026-07-03 08:00:00+07',
     '2026-06-01 00:00:00+07', '2026-06-30 23:59:59+07'),

    -- Điểm TB học phần — user 1101: T4=7.2, T5=7.5
    ('b2000004-0000-4000-8000-000000000013', 'b0000000-0000-0000-0000-000000000001',
     'b2000003-0000-4000-8000-000000000007', '22222222-0000-0000-0000-000000001101',
     7.2, 48.0, '7.2 điểm', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', 'Tốt', '2026-05-03 08:00:00+07',
     '2026-04-01 00:00:00+07', '2026-04-30 23:59:59+07'),

    ('b2000004-0000-4000-8000-000000000014', 'b0000000-0000-0000-0000-000000000001',
     'b2000003-0000-4000-8000-000000000008', '22222222-0000-0000-0000-000000001101',
     7.5, 50.0, '7.5 điểm', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', 'Xuất sắc', '2026-06-03 08:00:00+07',
     '2026-05-01 00:00:00+07', '2026-05-31 23:59:59+07'),

    -- Điểm TB học phần — user 1102: T4=6.8, T5=7.1
    ('b2000004-0000-4000-8000-000000000015', 'b0000000-0000-0000-0000-000000000001',
     'b2000003-0000-4000-8000-000000000007', '22222222-0000-0000-0000-000000001102',
     6.8, 45.3, '6.8 điểm', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', 'Đạt', '2026-05-03 08:00:00+07',
     '2026-04-01 00:00:00+07', '2026-04-30 23:59:59+07'),

    ('b2000004-0000-4000-8000-000000000016', 'b0000000-0000-0000-0000-000000000001',
     'b2000003-0000-4000-8000-000000000008', '22222222-0000-0000-0000-000000001102',
     7.1, 47.3, '7.1 điểm', 'PENDING',
     NULL, NULL, NULL,
     '2026-05-01 00:00:00+07', '2026-05-31 23:59:59+07'),

    -- Điểm rèn luyện — user 1101: T4=78, T5=82
    ('b2000004-0000-4000-8000-000000000017', 'b0000000-0000-0000-0000-000000000001',
     'b2000003-0000-4000-8000-000000000009', '22222222-0000-0000-0000-000000001101',
     78, 48.8, '78 điểm', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', 'Tốt', '2026-05-03 08:00:00+07',
     '2026-04-01 00:00:00+07', '2026-04-30 23:59:59+07'),

    ('b2000004-0000-4000-8000-000000000018', 'b0000000-0000-0000-0000-000000000001',
     'b2000003-0000-4000-8000-000000000010', '22222222-0000-0000-0000-000000001101',
     82, 50.0, '82 điểm', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', 'Xuất sắc', '2026-06-03 08:00:00+07',
     '2026-05-01 00:00:00+07', '2026-05-31 23:59:59+07'),

    -- Điểm rèn luyện — user 1102: T4=72, T5=75
    ('b2000004-0000-4000-8000-000000000019', 'b0000000-0000-0000-0000-000000000001',
     'b2000003-0000-4000-8000-000000000009', '22222222-0000-0000-0000-000000001102',
     72, 45.0, '72 điểm', 'APPROVED',
     '22222222-0000-0000-0000-000000001001', 'Đạt', '2026-05-03 08:00:00+07',
     '2026-04-01 00:00:00+07', '2026-04-30 23:59:59+07'),

    ('b2000004-0000-4000-8000-000000000020', 'b0000000-0000-0000-0000-000000000001',
     'b2000003-0000-4000-8000-000000000010', '22222222-0000-0000-0000-000000001102',
     75, 46.9, '75 điểm', 'PENDING',
     NULL, NULL, NULL,
     '2026-05-01 00:00:00+07', '2026-05-31 23:59:59+07');
