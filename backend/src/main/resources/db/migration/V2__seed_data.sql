...
WHERE code IN (
    ...
    'ATTACHMENT:UPLOAD',
    'REMINDER:SEND',
    -- BSC (chỉ có KPI:VIEW ⇒ chỉ BSC:VIEW)
    'BSC:VIEW',
...
WHERE code IN (
    ...
    'CYCLE_EVAL:VIEW', 'CYCLE_EVAL:FINALIZE',
    'ATTACHMENT:UPLOAD',
    -- BSC (chỉ có KPI:VIEW ⇒ chỉ BSC:VIEW, để dùng selector viễn cảnh)
    'BSC:VIEW',
    -- PERSONAL_PERMS
    'KPI:VIEW_MY', 'SUBMISSION:VIEW_MY', 'EVALUATION:VIEW_MY', 'STATS:VIEW_MY', 'ADJUSTMENT:VIEW_MY'
)
